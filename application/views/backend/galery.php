        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <button type="button" class="btn btn-success" onclick="add_galery()"><i class="fa fa-plus"></i> Tambah Galery</button>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="table_gal" class="table table-bordered table-striped">
                <thead>
                <tr>
    ...
    <div class="modal-content">
	    ...
	    <div class="modal-body form">
	        <form action="#" id="form" class="form-horizontal">
	            <input type="hidden" value="" name="id_gal"/>
	            <div class="form-body">
	            	<div class="form-group">
	                    <label class="control-label col-md-3">Judul</label>
	                    <div class="col-md-9">
	                        <input type="text" name="judul" placeholder="Judul galery" class="form-control" rows="5"></textarea>
	                ...
	                <div class="form-group">
	                    ...
	                    <div class="col-md-9">
	                        <input name="photo_gal" type="file">
	                        <span class="help-block"></span>
	                    </div>
	                </div>
                    <div class="form-group">
                        <div class="col-md-12">
                            ...
                            <span>Ukuran maximal Upload <b>2 MB</b> dengan resolusi <b>700 x 700 pixel</b>.</span>
                        </div>
                    </div>
	            </div>
	        </form>
    ...
    function edit_galery(id)
    {
        ...
        $.ajax({
            ...
            success: function(data)
            {
                ...
                $('[name="id_gal"]').val(data.id_gal);
                $('[name="judul"]').val(data.judul);
                $('#cat').val(data.cat);
                $('[name="deskripsi"]').val(data.desc);
                ...
                if(data.photo_gal)
                {
                    ...
                    $('#photo-preview div').html('<img src="'+base_url+'./assets/img/galery/'+data.photo_gal+'" class="img-responsive">'); // show photo
                    $('#photo-preview div').append('<input type="checkbox" name="remove_photo" value="'+data.photo_gal+'"/> Remove photo when saving'); // remove photo
